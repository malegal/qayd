...
اعتمدت الواجهة لاحقًا التقسيم القانوني النهائي إلى **ملف قضائي** للقضايا ذات جلسات المحكمة، و**ملف إجرائي** لتحقيقات النيابة وتجديد الحبس ولجان فض المنازعات والتظلمات والإجراءات القانونية، و**ملف خدمي** لتسجيل العقارات والعقود وتأسيس الشركات. كما تم إصلاح منتقي المستندات ليكون تابعًا لنافذة التطبيق ويستعيد التركيز بعد الإغلاق.
