...
في التحديث اللاحق، تم استبدال زر «تحقيق +» بزر «ملف إداري +». الزر الجديد ينشئ سجلًا من النوع `administrative` مع كود `AD`، مع إبقاء أنواع الملفات القديمة مدعومة للتوافق مع البيانات الموجودة.
